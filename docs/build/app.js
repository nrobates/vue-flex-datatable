...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(151)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(25), __webpack_require__(154), __webpack_require__(21), __webpack_require__(46), __webpack_require__(48), __webpack_require__(47)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
    factory(exports, require('./settings'), require('./components/FlexTable.vue'), require('./components/FlexTableColumn.vue'), require('./components/FlexTableHeaderColumn.vue'), require('./components/FlexTableToggle.vue'), require('./components/FlexTableRow.vue'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.settings, global.FlexTable, global.FlexTableColumn, global.FlexTableHeaderColumn, global.FlexTableToggle, global.FlexTableRow);
    global.index = mod.exports;
  }
})(this, function (exports, _settings2, _FlexTable, _FlexTableColumn, _FlexTableHeaderColumn, _FlexTableToggle, _FlexTableRow) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.FlexTableToggle = exports.FlexTableHeaderColumn = exports.FlexTableColumn = exports.FlexTableRow = exports.FlexTable = undefined;
  ...
  exports.default = {
    install: function install(Vue) {
      ...
      Vue.component('flex-table-toggles', _FlexTableToggle2.default);
    },
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(23), __webpack_require__(50)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
  ...
  new _vue2.default({
    ...
    components: {
      FlexTable: _src.FlexTable,
      FlexTableColumn: _src.FlexTableColumn,
      FlexTableToggle: _src.FlexTableToggle
    },
    ...
    data: {
      ...
      }, { name: 'Jane Doe', email: 'janedoe@example.com', phone: '222-222-2222', nested: { song: 'Enter Sandman' } }, { name: 'Jack Davis', email: 'jackdavis@example.com', phone: '222-222-2222', nested: { song: 'Fire and Ice' } }, { name: 'Joan Davis', email: 'joandavis@example.com', phone: '222-222-2222', nested: { song: 'Crackerman' } }]
    }
  });
});
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(57), __webpack_require__(20), __webpack_require__(23), __webpack_require__(25), __webpack_require__(24), __webpack_require__(48), __webpack_require__(21), __webpack_require__(46), __webpack_require__(47)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
    factory(exports, require('babel-runtime/core-js/object/assign'), require('lodash'), require('vue'), require('../settings'), require('../helpers'), require('./FlexTableToggle.vue'), require('./FlexTableColumn.vue'), require('./FlexTableHeaderColumn.vue'), require('./FlexTableRow.vue'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.assign, global.lodash, global.vue, global.settings, global.helpers, global.FlexTableToggle, global.FlexTableColumn, global.FlexTableHeaderColumn, global.FlexTableRow);
    global.FlexTable = mod.exports;
  }
})(this, function (exports, _assign, _lodash, _vue, _settings, _helpers, _FlexTableToggle, _FlexTableColumn, _FlexTableHeaderColumn, _FlexTableRow) {
  'use strict';
  ...
  exports.default = {
    ...
    computed: {
      mappedColumns: function mappedColumns() {
        return this.columns.map(function (col) {
          var columnMap = {};
          (0, _assign2.default)(columnMap, _settings2.default.columnSettings, col);
          return col;
        });
      },
      columnToggles: function columnToggles() {
        return this.mappedColumns.filter(function (column) {
      ...
      displayedRows: function displayedRows() {
        ...
        return this.sortedRows.filter(function (row) {
          return _this.visibleColumns.filter(function (column) {
            return column.filterable === true;
          }).map(function (column) {
            return _lodash2.default.get(row, column.show).toString().toLowerCase();
          }).filter(function (filteredValue) {
            return filteredValue.includes(_this.filter.toLowerCase());
          }).length;
        });
      },
    ...
    methods: {
      ...
      getColumn: function getColumn(columnName) {
        return this.mappedColumns.find(function (column) {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  exports.default = {
    ...
    computed: {
      columnContent: function columnContent() {
        if (_lodash2.default.isFunction(this.column.formatter)) {
          return this.column.formatter(_lodash2.default.get(this.row, this.show), this.row);
        }
        return _lodash2.default.get(this.row, this.show);
      }
    },
    watch: {},
    methods: {},
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    ...
    factory(exports, require('lodash'), require('./FlexTableColumn.vue'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.lodash, global.FlexTableColumn);
    global.FlexTableRow = mod.exports;
  }
})(this, function (exports, _lodash, _FlexTableColumn) {
  'use strict';
  ...
  exports.default = {
    ...
    computed: {
      ...
      childRowColumn: function childRowColumn() {
        return _lodash2.default.get(this.data, this.childRowsKey);
      }
    }
  };
});
...
// module
exports.push([module.i, ".flex-table-column-header.flex-table-column-sort[data-v-cebca05a]{text-decoration:underline;cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.flex-table-column-header.flex-table-column-sort.flex-table-column-sort-asc[data-v-cebca05a]:after,.flex-table-column-header.flex-table-column-sort.flex-table-column-sort-desc[data-v-cebca05a]:after{position:absolute;right:.25em;display:inline-block;color:#bbb}.flex-table-column-header.flex-table-column-sort.flex-table-column-sort-asc[data-v-cebca05a]:after{content:\"\\2191\"}.flex-table-column-header.flex-table-column-sort.flex-table-column-sort-desc[data-v-cebca05a]:after{content:\"\\2193\"}", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "col-12 col-md-6 mb-2 text-center"
    ...
    staticClass: "col-12 col-md-6 mb-2 align-content-center"
  }, [_c('span', [_c('strong', [_vm._v(_vm._s(_vm.toggleLabel))])]), _vm._v(" "), _vm._l((_vm.columnToggles), function(toggle, tIndex) {
    ...
    }, _vm._l((_vm.childRowColumn(row)), function(childRow, crIndex) {
      return _c('flex-table-row', {
        key: rIndex + '-' + crIndex,
        attrs: {
          "data": childRow,
  ...
  return _c('div', {
    staticClass: "col-12 col-md-6 mb-2 text-right align-content-center"
  }, [_c('span', [_c('strong', [_vm._v("Group By: ")])])])
}]}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('td', [_vm._v(_vm._s(_vm.columnContent))])
},staticRenderFns: []}
...
var update = __webpack_require__(49)("3bf7d302", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(49)("4e6de4ae", content, true);
